---
name: Pieper & Wagner Pflege-Design
colors:
  surface: '#FFFFFF'
  surface-dim: '#d9d9df'
...
# Design System – Pieper & Wagner Pflegedienst

**Projekt:** Webseiten-Neugestaltung für Pieper & Wagner – Häusliche Krankenpflege
...
### 1.1 Markenkern
Pieper & Wagner ist ein lokal verwurzelter, familiär geführter Pflegedienst aus Wuppertal-Cronenberg. Die Marke steht für **kompetente, persönliche und verlässliche** häusliche Krankenpflege. Der Auftritt soll professionell-medizinisch wirken, dabei aber niemals klinisch-distanziert.

### 1.2 Markenwerte
- **Vertrauen** – über Jahre gewachsen, im Stadtteil verankert
...
"Wir sind für Sie da, wenn Sie uns brauchen. Persönlich. Zuverlässig. Seit Jahren in Cronenberg verwurzelt."
...
- **Meta-Title-Pattern:** `[Seitentitel] | Pieper & Wagner – Häuslicher Pflegedienst Wuppertal`
...
- [ ] Telefonnummer Pieper & Wagner (für Header/Footer)
- [ ] IK-Nummer (für Footer-Trust-Badge)
- [ ] Genaue Stadtteile im Einzugsgebiet (für Karte)
- [ ] Anzahl Mitarbeiter und ggf. PDL-Name (für Über-uns-Seite)
- [ ] Öffnungszeiten / Bereitschaftszeiten
- [ ] Logo-Design-Briefing (Wortmarke vs. Bildmarke, Symbol-Ideen)
- [ ] Foto-Shooting-Termin abstimmen
- [ ] Tech-Stack final entscheiden (WordPress vs. Headless)
- [ ] Pflegegradrechner: Eigenentwicklung oder Drittanbieter-Widget?
- [ ] Domain-Strategie: pieper-wagner.de bleibt oder neue Domain?
